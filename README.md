...
<head>
    ...
    <title>Simple Bounce Game</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <script>
        ...
        function createBricks() {
            ...
            for (let r = 0; r < brickRows; r++) {
                for (let c = 0; c < brickCols; c++) {
                    ...
                    const hue = (r * 60) % 360;
                    brick.style.backgroundColor = `hsl(${hue}, 80%, 50%)`;
        ...
        function handleMouseMove(e) {
            ...
            if (paddleX < 0) {
                paddleX = 0;
            } else if (paddleX > gameContainer.offsetWidth - paddle.offsetWidth) {
        ...
        function moveBall() {
            ...
            if (
                ...
                ballSpeedX = normalizedHit * 5; // Max horizontal speed
        ...
        function gameOver(win = false) {
            gameRunning = false;
            finalScoreDisplay.textContent = win ? 
